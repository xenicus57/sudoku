...
SDK_v01.py
Version 01
Trata de resolver un sudoku con 2 estrategias, no está implementado Fuerza Bruta, además los valores de configuracion estan cargados en el propio programa
en ese caso un Sudoku de 9 x 9. El plantamiento de resolucion es independiente del tipo de sudoku.
"""
